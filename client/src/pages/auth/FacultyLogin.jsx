...
export default function FacultyLogin() {
  ...
  return (
    <div className="max-w-md mx-auto px-6 pt-20">
      <h1 className="font-display text-3xl mb-1">Faculty sign in</h1>
      <p className="text-ink2 mb-8">Manage your subjects, materials, and quizzes.</p>
      ...
      <p className="text-ink2 text-sm mt-4 text-center">
        New faculty member? <Link to="/faculty/register" className="text-glow hover:underline">Create an account</Link>
      </p>
      <p className="text-ink2 text-sm mt-2 text-center">
        Student? <Link to="/student/login" className="text-glow hover:underline">Sign in here</Link>
      </p>
    </div>
  );
}
