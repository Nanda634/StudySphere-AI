...
import { Eye, EyeOff, GraduationCap, BookOpen, Brain, ShieldCheck } from "lucide-react";
      ...
      <div className="relative mx-auto flex min-h-screen w-full max-w-7xl flex-col lg:flex-row items-center justify-center px-6 py-10 gap-10">
        ...
        <section className="hidden lg:flex flex-1 flex-col justify-center">
          <span className="inline-flex w-fit items-center gap-2 rounded-full border border-cyan-400/20 bg-cyan-400/10 px-4 py-2 text-cyan-300">
            <GraduationCap size={18}/> StudySphere AI
          </span>
          ...
          <p className="mt-6 max-w-xl text-slate-300 text-lg leading-8">
            Continue your learning journey using AI generated notes,
            flashcards, quizzes, attendance tracking and personalized analytics.
          </p>

          <div className="mt-12 grid grid-cols-2 gap-5">
            <Feature icon={<BookOpen size={22}/>} title="Smart Notes" text="Summaries generated instantly." />
            <Feature icon={<Brain size={22}/>} title="AI Quiz" text="Adaptive learning quizzes." />
            <Feature icon={<ShieldCheck size={22}/>} title="Secure Login" text="Protected authentication." />
            <Feature icon={<GraduationCap size={22}/>} title="Track Progress" text="Monitor performance." />
          </div>
        </section>
        ...
        <section className="w-full max-w-md">
          <div className="rounded-3xl border border-white/10 bg-white/5 backdrop-blur-xl p-8 shadow-2xl">
            ...
            <div className="text-center">
              ...
              <h2 className="mt-5 text-3xl font-bold">Student Login</h2>
            ...
            <form onSubmit={handleSubmit} className="mt-8 space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-white/10 bg-[#111c2f] px-4 py-3 outline-none transition focus:border-cyan-400"
                />
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-white/10 bg-[#111c2f] px-4 py-3 pr-12 outline-none transition focus:border-cyan-400"
                  />
            ...
            <p className="mt-8 text-center text-slate-400">
              New student?
              <Link to="/student/register" className="ml-2 font-semibold text-cyan-400 hover:underline">
                Register
              </Link>
            </p>
            ...
            <p className="mt-3 text-center text-slate-400">
              Faculty?
              <Link to="/faculty/login" className="ml-2 font-semibold text-cyan-400 hover:underline">
                Login Here
              </Link>
            </p>
